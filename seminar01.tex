...
\begin{frame}{Знакомство с bash}
		...
		\begin{center}
			\includegraphics[width=5cm]{files/01/bash.png}
...
\begin{frame}{Запуск исполняемых файлов}
	...
	\inputminted[linenos,bgcolor=listing]{bash}{files/01/arglist.sh}\pause
	\vspace*{-\baselineskip}
...
\begin{frame}
	\texttt{outer.sh}
	\inputminted[linenos,bgcolor=listing]{bash}{files/01/outer.sh}
	\texttt{inner.sh}
	\inputminted[linenos,bgcolor=listing]{bash}{files/01/inner.sh}
\end{frame}
...
\begin{frame}{Оператор \texttt{if}}
	...
	\end{itemize}
	\vspace*{-\baselineskip}
	\inputminted[linenos,bgcolor=listing]{bash}{files/01/if.sh}\pause
	\vspace*{-\baselineskip}
	\begin{itemize}
...
\begin{frame}{Цикл \texttt{while}}
	...
	\inputminted[linenos,bgcolor=listing]{bash}{files/01/while.sh}
\end{frame}
